        ...
        State::FetchOpcode => {
            ...
            let new_state = 
                match op {
                    ...
                    0x14 => add_opcode!(NopZpX, opcode, cpu),
                    0x1A => add_opcode!(NopIllegal, opcode, cpu),
                    0x0A => add_opcode!(AslA, opcode, cpu),
                    0x0C => add_opcode!(NopAbs, opcode, cpu),
                    ...
                    0x1C => add_opcode!(NopAbsX, opcode, cpu),
                    ...
                    0x34 => add_opcode!(NopZpX, opcode, cpu),
                    ...
                    0x3A => add_opcode!(NopIllegal, opcode, cpu),
                    0x3C => add_opcode!(NopAbsX, opcode, cpu),
                    ...
                    0x54 => add_opcode!(NopZpX, opcode, cpu),
                    ...
                    0x5A => add_opcode!(NopIllegal, opcode, cpu),
                    0x5C => add_opcode!(NopAbsX, opcode, cpu),
                    ...
                    0x74 => add_opcode!(NopZpX, opcode, cpu),
                    ...
                    0x7A => add_opcode!(NopIllegal, opcode, cpu),
                    0x7C => add_opcode!(NopAbsX, opcode, cpu),
                    0x7D => add_opcode!(AdcAbsX, opcode, cpu),
                    0x7E => add_opcode!(RorAbsX, opcode, cpu),
                    0x80 => add_opcode!(NopImm, opcode, cpu),
                    ...
                    0xD4 => add_opcode!(NopZpX, opcode, cpu),
                    ...
                    0xDA => add_opcode!(NopIllegal, opcode, cpu),
                    0xDC => add_opcode!(NopAbsX, opcode, cpu),
                    ...
                    0xF4 => add_opcode!(NopZpX, opcode, cpu),
                    ...
                    0xFA => add_opcode!(NopIllegal, opcode, cpu),
                    0xFC => add_opcode!(NopAbsX, opcode, cpu),
                    0xFD => add_opcode!(SbcAbsX, opcode, cpu),
                    0xFE => add_opcode!(IncAbsX, opcode, cpu),
                    _ => {
                        /*TODO deal with errors */
                        println!("Unknown opcode {:#X}, abort", op);
                        State::Done
                    }
                };
...
fn main() {
    ...
    let mut nr = 7; // TODO: nestest only ?
    let mut ppu_cycle = 0;

    let start = SystemTime::now();

    loop {
        state = cycle(&mut cpu, &mut opcode, state, &mut nr, &mut ppu_cycle);
        nr = nr + 1;
        ppu_cycle = ppu_cycle + 3;
        match state {
            // State::Done => cpu.pc = 0,
            State::Done => break,
            _ => {}
